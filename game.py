...
icon = pygame.transform.scale(icon,(screen_width,screen_height)).convert_alpha()
...
def welcome():
    exit_game=False
    while not exit_game:
        # gameWindow.fill((255,240,250))
        # gameWindow.fill((0,0,0))
        gameWindow.blit(icon,(0,0))
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            # text_screen("Game Over! Press Enter To Continue!!",red,screen_width/7.5,screen_height/2)
            text_screen("Game Over! Press Enter To Continue!!",red,150,540)
            ...
            plot_snake(gameWindow,black,snak_list,snake_size)
        pygame.display.update()
        clock.tick(fps)
